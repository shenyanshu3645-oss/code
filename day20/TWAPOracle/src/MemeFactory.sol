...
contract MemeFactory {
    ...
    function buyMeme(address tokenAddr) external payable {
        ...
        uint _minexpectedOutput = minexpectedOutput;

        uint[] memory amountsout = IUniswapV2Router02(_uniswapRouter)
            .swapExactETHForTokens{value: _msgValue}(
            _minexpectedOutput,
            path,
            _msgSender,
            block.timestamp + 30000
        ...
        emit BuyMeme(_tokenAddr, _msgSender, amountsout[1]);
    }
