...
export const loadABIFromSrc = (contractName: string): Abi => {
    try {
        ...
        switch (contractName) {
            case 'TokenBank':
                contractJson = require('../abi/TokenBankPermit.json');
                break;
            case 'TokenBankPermit':
                contractJson = require('../abi/TokenBankPermit.json');
                break;
            case 'TokenBankPermit2':
                contractJson = require('../abi/TokenBankPermit2.json');
                break;
            case 'MErc20Permit':
                contractJson = require('../abi/MErc20Permit.json');
                break;
            case 'MyToken':
            case 'ERC20':
                contractJson = require('../abi/MErc20Permit.json');
